...
export const DATA = {
  ...
  summary:
    "I build AI products and brand stories that travel between Korea and the US — fluent in both markets, shipping into both.\n\nCurrently building [Fastlane](#projects) (an AI evaluation platform, officially adopted at Kookmin SYNC 2026) and driving design, brand, and launch content at [Sellii](#projects) (an agent that hunts underpriced marketplace deals).\n\nBefore AI, Editor-in-Chief at Korea's largest student newspaper — grew Instagram 1.5× and web traffic 40%+ in one semester.\n\nDouble major in MIS and Software Engineering. Based in Irvine, CA — *[authorized to work in the US.](#contact)*",
  avatarUrl: "/me.png",
  skills: [
